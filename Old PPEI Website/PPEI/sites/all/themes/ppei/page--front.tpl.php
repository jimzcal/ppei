        ...
        <div id="wrapper">
            <div id="topWrapper">
				...
				<div id="logoSpace">
                    ...
                    <div id="siteSlogan"><p><?php print $site_slogan; ?></p></div>
				</div>
				<?php endif; ?>
            ...
            <div id="widthWrapper">
            	<?php print $messages; ?>
                    ...
                    <?php print render($page['mainarticle']); ?>
                ...
                <div class="aboveFooter">
                    <?php print render($page['above_footer_up']); ?>
                </div>

                <div class="aboveFooter">
                    <?php print render($page['above_footer_down']); ?>
                </div>
